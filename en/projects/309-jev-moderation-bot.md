...
- List: [kraayenjon/awesome-jev](https://github.com/kraayenjon/awesome-jev/blob/22570dcd8662ae039860a1dfad7d7aec4aff8e15/README.md#L309) `README.md:309` at `22570dcd` (CC0). The fivetaku/awesome-jev fork was cloned at this commit.
...
- Run-confirmed, GitHub API 2026-09-22: `brainstormity/Jev-Moderation-Bot`, 41 stars, SPDX MIT, push 2026-09-22, archived False, language Python.
- The list's CC0 does not cover this repository. Its license is MIT.

## Role Jev plays

The list says: Discord bot scoring incoming messages for phishing, spam, and social engineering, with a four-stage escalation ladder. Rows in this section are usually a closed label, hire or not, which intent, buy or sell, allow or block, with money, messages, and records left in ordinary code. Those examples are the section's, not a finding that this row is one of them. This page did not trace the side effects.
