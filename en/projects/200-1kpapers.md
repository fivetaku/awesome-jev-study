...
- List: [kraayenjon/awesome-jev](https://github.com/kraayenjon/awesome-jev/blob/22570dcd8662ae039860a1dfad7d7aec4aff8e15/README.md#L200) `README.md:200` at `22570dcd` (CC0). The fivetaku/awesome-jev fork was cloned at this commit.
- Section: Featured builds with real numbers
- URL: https://madewithjev.com/builds/1kpapers
- Checked: 2026-09-22
...
- Numbers printed in the list: 1,018 papers. Author-reported (README.md:209). Not remeasured.

## Role Jev plays

Jev asks the same closed questions of every item in a pile the author already assembled. The list says: A corpus classified by topic and published as a site The figures next to that sentence are author-reported. README.md:209 says the list did not measure them. This study did not either.
