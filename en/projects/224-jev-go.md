...
- List: [kraayenjon/awesome-jev](https://github.com/kraayenjon/awesome-jev/blob/22570dcd8662ae039860a1dfad7d7aec4aff8e15/README.md#L224) `README.md:224` at `22570dcd` (CC0). The fivetaku/awesome-jev fork was cloned at this commit.
...
- Run-confirmed, GitHub API 2026-09-22: `Gaurav-Gosain/jev-go`, 3 stars, SPDX MIT, push 2026-09-16, archived False, language Go.
- The list's CC0 does not cover this repository. Its license is MIT.
- API description: Go client for TypeSafe's System One API and its model Jev: typed judgments and calibrated probabilities instead of generated text

## Role Jev plays

This repository is a client, not the model. Jev stays at the remote System One endpoint. The package is the call in one language. The list's sentence: `go get github.com/Gaurav-Gosain/jev-go`. Also [Stumble/jev-go](https://github.com/Stumble/jev-go) - dependency-free, works against TypeSafe direct and Vercel AI Gateway, with an interactive CLI and an installable agent skill.
...
The list sentence names: `go get github.com/Gaurav-Gosain/jev-go`. That is the list's sentence, not a config file traced in source.
