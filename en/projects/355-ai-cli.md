...
[한국어](../../ko/projects/355-ai-cli.md) · [English](../../en/projects/355-ai-cli.md)

- List: [kraayenjon/awesome-jev](https://github.com/kraayenjon/awesome-jev/blob/22570dcd8662ae039860a1dfad7d7aec4aff8e15/README.md#L355) `README.md:355` at `22570dcd` (CC0). The fivetaku/awesome-jev fork was cloned at this commit.
...
- Run-confirmed, GitHub API 2026-09-22: `vercel-labs/ai-cli`, 811 stars, SPDX none, push 2026-09-19, archived False, language TypeScript.
- API description: Generate anything from your terminal

## Role Jev plays

Jev is exposed as a tool an agent can call, or as a gate in front of an agent that already writes text. The list says: Vercel Labs CLI that can run Jev as the evaluation model for its `evaluate` command. The agent loop, the permissions, and the side effects are not Jev. This page did not trace them.
