...
- List: [kraayenjon/awesome-jev](https://github.com/kraayenjon/awesome-jev/blob/22570dcd8662ae039860a1dfad7d7aec4aff8e15/README.md#L294) `README.md:294` at `22570dcd` (CC0). The fivetaku/awesome-jev fork was cloned at this commit.
...
- Run-confirmed, GitHub API 2026-09-22: `0xNatoshi/jev-codex-router`, 209 stars, SPDX MIT, push 2026-09-22, archived False, language JavaScript.
- The list's CC0 does not cover this repository. Its license is MIT.
- API description: Per-turn model & reasoning routing for Codex, driven by Jev (TypeSafe System One): picks the model, thinking depth and speed mode for every turn.

## Role Jev plays

Jev's Choice picks the next model, skill, or route. Generation, if any, happens after that pick. The list says: Per-turn Codex routing: Jev picks model, thinking depth, and speed mode. This page did not trace the routing rule in source.
