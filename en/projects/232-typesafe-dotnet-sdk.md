...
[한국어](../../ko/projects/232-typesafe-dotnet-sdk.md) · [English](../../en/projects/232-typesafe-dotnet-sdk.md)

- List: [kraayenjon/awesome-jev](https://github.com/kraayenjon/awesome-jev/blob/22570dcd8662ae039860a1dfad7d7aec4aff8e15/README.md#L232) `README.md:232` at `22570dcd` (CC0). The fivetaku/awesome-jev fork was cloned at this commit.
- Section: SDKs and clients
- URL: https://github.com/saibimajdi/typesafe-dotnet-sdk
- Checked: 2026-09-22
...
- Run-confirmed, GitHub API 2026-09-22: `saibimajdi/typesafeai-dotnet-sdk`, 6 stars, SPDX MIT, push 2026-09-18, archived False, language C#.
- The list's CC0 does not cover this repository. Its license is MIT.
- API description: Community .NET SDK for the TypeSafe AI System One API — typed noul, choice, and score questions with structured, confidence-scored answers. Not affiliated with TypeSafe AI.

## Role Jev plays

This repository is a client, not the model. Jev stays at the remote System One endpoint. The package is the call in one language. The list's sentence: typed questions and confidence-scored answers.
