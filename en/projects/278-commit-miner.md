...
- List: [kraayenjon/awesome-jev](https://github.com/kraayenjon/awesome-jev/blob/22570dcd8662ae039860a1dfad7d7aec4aff8e15/README.md#L278) `README.md:278` at `22570dcd` (CC0). The fivetaku/awesome-jev fork was cloned at this commit.
...
- Run-confirmed, GitHub API 2026-09-22: `devanshbatham/commit-miner`, 35 stars, SPDX none, push 2026-09-17, archived False, language Rust.
- API description: Classify Git commit diffs and messages with Jev. Bug fixes, security fixes/CWEs, and change types.

## Role Jev plays

The list says: Rust CLI that classifies commit diffs: bug fixes, security/CWEs, and change types. HTML/CSV reports. Rows filed in this section are usually a judgment over a diff, a log, a commit, or a string already extracted, and ordinary code keeps the filesystem and the git calls. That is the section's shape. It is not a finding that this row matches it. This page did not trace the code.
