...
- List: [kraayenjon/awesome-jev](https://github.com/kraayenjon/awesome-jev/blob/22570dcd8662ae039860a1dfad7d7aec4aff8e15/README.md#L368) `README.md:368` at `22570dcd` (CC0). The fivetaku/awesome-jev fork was cloned at this commit.
...
- Run-confirmed, GitHub API 2026-09-22: `shantanugoel/ask-jev-skill`, 38 stars, SPDX MIT, push 2026-09-17, archived False, language Python.
- The list's CC0 does not cover this repository. Its license is MIT.
- API description: Skill for Hermes, and other agents, to ask typesafe's jev

## Role Jev plays

Jev is exposed as a tool an agent can call, or as a gate in front of an agent that already writes text. The list says: Hermes skill: ask Jev whenever the agent needs a bounded decision. The agent loop, the permissions, and the side effects are not Jev. This page did not trace them.
