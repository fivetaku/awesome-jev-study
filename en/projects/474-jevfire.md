...
- List: [kraayenjon/awesome-jev](https://github.com/kraayenjon/awesome-jev/blob/22570dcd8662ae039860a1dfad7d7aec4aff8e15/README.md#L474) `README.md:474` at `22570dcd` (CC0). The fivetaku/awesome-jev fork was cloned at this commit.
...
- Run-confirmed, GitHub API 2026-09-22: `kikoncuo/jevfire`, 22 stars, SPDX MIT, push 2026-09-18, archived False, language JavaScript.
- The list's CC0 does not cover this repository. Its license is MIT.
- API description: JEV-inspired parallel decisions for CUDA LLMs. One context, many decisions. vLLM API, game-agent examples, and reproducible benchmarks.

## Role Jev plays

This row is a paper, a local model, or an open artifact sitting next to the claim. The list says: Jev-inspired parallel decisions for CUDA LLMs via vLLM, with a browser Mario demo (~71 ms/action locally). Jev is not assumed to be a dependency. The front matter was checked for whether it even names Jev. Source was not traced.
