...
- List: [kraayenjon/awesome-jev](https://github.com/kraayenjon/awesome-jev/blob/22570dcd8662ae039860a1dfad7d7aec4aff8e15/README.md#L453) `README.md:453` at `22570dcd` (CC0). The fivetaku/awesome-jev fork was cloned at this commit.
...
- Run-confirmed, GitHub API 2026-09-22: `bitnovus/jev-spam-eval`, 0 stars, SPDX MIT, push 2026-09-18, archived False, language Jupyter Notebook.
- The list's CC0 does not cover this repository. Its license is MIT.
- API description: Zero-shot spam filtering with TypeSafe Jev Noul questions, compared with TF-IDF baselines

## Role Jev plays

This row is a harness or a published eval, not a product feature. The list says: Zero-shot spam study vs trained TF-IDF baselines, with post-hoc-tuning caveats. Official numbers on the list are vendor-reported. This study did not rerun the harness. A fetch of evals.typesafe.ai on 2026-09-22 did not contain the headline percentages an earlier, longer extract had quoted, so those percentages are not restated here.
