...
[한국어](../../ko/projects/234-typesafe-on-neon.md) · [English](../../en/projects/234-typesafe-on-neon.md)

- List: [kraayenjon/awesome-jev](https://github.com/kraayenjon/awesome-jev/blob/22570dcd8662ae039860a1dfad7d7aec4aff8e15/README.md#L234) `README.md:234` at `22570dcd` (CC0). The fivetaku/awesome-jev fork was cloned at this commit.
- Section: SDKs and clients
- URL: https://github.com/andrelandgraf/typesafe-on-neon
- Checked: 2026-09-22
...
- Run-confirmed, GitHub API 2026-09-22: `andrelandgraf/safer-with-jev`, 4 stars, SPDX none, push 2026-09-18, archived False, language TypeScript.
- API description: Neon Function proxy for the Neon AI Gateway with TypeSafe Jev routing.

## Role Jev plays

This repository is a client, not the model. Jev stays at the remote System One endpoint. The package is the call in one language. The list's sentence: Neon Function proxy for the Neon AI Gateway.
