...
[한국어](../../ko/projects/374-jev-guard.md) · [English](../../en/projects/374-jev-guard.md)

- List: [kraayenjon/awesome-jev](https://github.com/kraayenjon/awesome-jev/blob/22570dcd8662ae039860a1dfad7d7aec4aff8e15/README.md#L374) `README.md:374` at `22570dcd` (CC0). The fivetaku/awesome-jev fork was cloned at this commit.
...
- Run-confirmed, GitHub API 2026-09-22: `leepokai/jev-guard`, 22 stars, SPDX MIT, push 2026-09-17, archived False, language JavaScript.
- The list's CC0 does not cover this repository. Its license is MIT.
- API description: Auto mode for every coding agent, built on Jev: risk-scores every tool call with session context (deny / ask / allow), flags prompt injection in results, checks skills and plugins.

## Role Jev plays

Jev is exposed as a tool an agent can call, or as a gate in front of an agent that already writes text. The list says: Prompt-injection and dangerous-action guard for Claude Code, Codex, Pi, and ACP agents. The agent loop, the permissions, and the side effects are not Jev. This page did not trace them.
