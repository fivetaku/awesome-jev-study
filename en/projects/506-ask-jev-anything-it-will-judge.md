...
[한국어](../../ko/projects/506-ask-jev-anything-it-will-judge.md) · [English](../../en/projects/506-ask-jev-anything-it-will-judge.md)

- List: [kraayenjon/awesome-jev](https://github.com/kraayenjon/awesome-jev/blob/22570dcd8662ae039860a1dfad7d7aec4aff8e15/README.md#L506) `README.md:506` at `22570dcd` (CC0). The fivetaku/awesome-jev fork was cloned at this commit.
- Section: Discussions
...
This row is not a Jev integration. It is a page, a post, a list, or a FAQ answer about Jev. The list says: Public Convex-backed demo inviting one million judged questions. There is no call setup to recover from a front matter that is not a project. Social text is not treated as a verified fact.
