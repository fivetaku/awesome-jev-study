...
[한국어](../../ko/projects/258-blink.md) · [English](../../en/projects/258-blink.md)

- List: [kraayenjon/awesome-jev](https://github.com/kraayenjon/awesome-jev/blob/22570dcd8662ae039860a1dfad7d7aec4aff8e15/README.md#L258) `README.md:258` at `22570dcd` (CC0). The fivetaku/awesome-jev fork was cloned at this commit.
...
- Run-confirmed, GitHub API 2026-09-22: `ellipsis-dev/blink`, 59 stars, SPDX none, push 2026-09-16, archived False, language TypeScript.
- API description: Codebase search powered by Jev from @typesafe-ai

## Role Jev plays

Jev scores, filters, or picks among passages, rows, or queries the rest of the system already fetched. The list says: Codebase search: an ensemble of walkers asks Jev which file answers a natural-language query. Retrieval itself stays a database, index, or crawler. This page did not trace that pipeline.
