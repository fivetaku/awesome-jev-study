...
[한국어](../../ko/projects/409-corpus-map-reduce.md) · [English](../../en/projects/409-corpus-map-reduce.md)

- List: [kraayenjon/awesome-jev](https://github.com/kraayenjon/awesome-jev/blob/22570dcd8662ae039860a1dfad7d7aec4aff8e15/README.md#L409) `README.md:409` at `22570dcd` (CC0). The fivetaku/awesome-jev fork was cloned at this commit.
...
This row is a decision shape, not a repository. The list says: Ask the same questions of every document: 1,018 papers, 3,282 posts, 724 ads, 1,500 emails. Read the aggregate, not the documents. Code is meant to own the branch after the label. No project here was traced, and the use-case map front we fetched did not confirm that the whole sentence matches the map.
