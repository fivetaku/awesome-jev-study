...
[한국어](../../ko/projects/322-more-robotics-and-devices-on-madewithjev-c.md) · [English](../../en/projects/322-more-robotics-and-devices-on-madewithjev-c.md)

- List: [kraayenjon/awesome-jev](https://github.com/kraayenjon/awesome-jev/blob/22570dcd8662ae039860a1dfad7d7aec4aff8e15/README.md#L322) `README.md:322` at `22570dcd` (CC0). The fivetaku/awesome-jev fork was cloned at this commit.
- Section: Robotics and hardware
- URL: https://madewithjev.com/categories/robotics-and-devices
- Checked: 2026-09-22
...
Jev's place is a discrete next action inside a control loop. Motors, setpoints, and safety interlocks are not the model. The list says: → [More robotics and devices on madewithjev.com](https://madewithjev.com/categories/robotics-and-devices) This page did not trace the loop and did not remeasure the rate.
