...
[한국어](../../ko/projects/229-jevclient.md) · [English](../../en/projects/229-jevclient.md)

- List: [kraayenjon/awesome-jev](https://github.com/kraayenjon/awesome-jev/blob/22570dcd8662ae039860a1dfad7d7aec4aff8e15/README.md#L229) `README.md:229` at `22570dcd` (CC0). The fivetaku/awesome-jev fork was cloned at this commit.
...
- Run-confirmed, GitHub API 2026-09-22: `AboveColin/jevclient`, 2 stars, SPDX MIT, push 2026-09-21, archived False, language Python.
- The list's CC0 does not cover this repository. Its license is MIT.
- API description: Async Python client for TypeSafe Jev. Typed questions in, probabilities and choices out, no prose to parse.

## Role Jev plays

This repository is a client, not the model. Jev stays at the remote System One endpoint. The package is the call in one language. The list's sentence: async client (`pip install jevclient`), separate from the official SDK.
...
The list sentence names: `pip install jevclient`. That is the list's sentence, not a config file traced in source.
