...
[한국어](../../ko/projects/193-jev-plays-doom.md) · [English](../../en/projects/193-jev-plays-doom.md)

- List: [kraayenjon/awesome-jev](https://github.com/kraayenjon/awesome-jev/blob/22570dcd8662ae039860a1dfad7d7aec4aff8e15/README.md#L193) `README.md:193` at `22570dcd` (CC0). The fivetaku/awesome-jev fork was cloned at this commit.
- Section: Featured builds with real numbers
- URL: https://madewithjev.com/builds/jev-plays-doom
- Checked: 2026-09-22
...
- Numbers printed in the list: ~10 queries/s, ~$7/hour. Author-reported (README.md:209). Not remeasured.
- The madewithjev front says the game state goes over as structured text, Jev returns the next action, and it reads text rather than frames. About 10 calls a second and about $7 an hour are author-reported.

## Role Jev plays

Jev's place is the next legal move, chosen from a state the game code rendered as text or as options. The list says: Game loop asking Jev what to do ~10 times a second The game, the legal-move generator, and the input injection sit outside the model. This page did not trace them and did not remeasure author-reported rates or costs.
