...
[한국어](../../ko/projects/410-real-time-control.md) · [English](../../en/projects/410-real-time-control.md)

- List: [kraayenjon/awesome-jev](https://github.com/kraayenjon/awesome-jev/blob/22570dcd8662ae039860a1dfad7d7aec4aff8e15/README.md#L410) `README.md:410` at `22570dcd` (CC0). The fivetaku/awesome-jev fork was cloned at this commit.
...
This row is a decision shape, not a repository. The list says: When the deadline is a frame, a block, or a tick, code generates legal actions and Jev picks one. Code is meant to own the branch after the label. No project here was traced, and the use-case map front we fetched did not confirm that the whole sentence matches the map.
