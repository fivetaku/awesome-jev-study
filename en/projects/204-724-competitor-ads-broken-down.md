...
[한국어](../../ko/projects/204-724-competitor-ads-broken-down.md) · [English](../../en/projects/204-724-competitor-ads-broken-down.md)

- List: [kraayenjon/awesome-jev](https://github.com/kraayenjon/awesome-jev/blob/22570dcd8662ae039860a1dfad7d7aec4aff8e15/README.md#L204) `README.md:204` at `22570dcd` (CC0). The fivetaku/awesome-jev fork was cloned at this commit.
- Section: Featured builds with real numbers
- URL: https://madewithjev.com/builds/competitor-ad-teardown
- Checked: 2026-09-22
...
- Numbers printed in the list: ~40 s, ~$0.09. Author-reported (README.md:209). Not remeasured.

## Role Jev plays

Jev asks the same closed questions of every item in a pile the author already assembled. The list says: Hook, format, offer, CTA per ad across 37 brands The figures next to that sentence are author-reported. README.md:209 says the list did not measure them. This study did not either.
