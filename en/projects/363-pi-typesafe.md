...
[한국어](../../ko/projects/363-pi-typesafe.md) · [English](../../en/projects/363-pi-typesafe.md)

- List: [kraayenjon/awesome-jev](https://github.com/kraayenjon/awesome-jev/blob/22570dcd8662ae039860a1dfad7d7aec4aff8e15/README.md#L363) `README.md:363` at `22570dcd` (CC0). The fivetaku/awesome-jev fork was cloned at this commit.
...
- Run-confirmed, GitHub API 2026-09-22: `DevMortimer/pi-typesafe`, 41 stars, SPDX MIT, push 2026-09-22, archived False, language TypeScript.
- The list's CC0 does not cover this repository. Its license is MIT.
- API description: TypeSafe decisions for Pi: batched evaluation tool, terminal playground, and typed API for extension authors

## Role Jev plays

Jev is exposed as a tool an agent can call, or as a gate in front of an agent that already writes text. The list says: Pi extension: one consented, key-managed TypeSafe client, batched `typesafe_evaluate`, offline-testable transport. The agent loop, the permissions, and the side effects are not Jev. This page did not trace them.
...
The list sentence names: `typesafe_evaluate`. That is the list's sentence, not a config file traced in source.
