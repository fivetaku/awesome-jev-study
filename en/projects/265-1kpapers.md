...
[한국어](../../ko/projects/265-1kpapers.md) · [English](../../en/projects/265-1kpapers.md)

- List: [kraayenjon/awesome-jev](https://github.com/kraayenjon/awesome-jev/blob/22570dcd8662ae039860a1dfad7d7aec4aff8e15/README.md#L265) `README.md:265` at `22570dcd` (CC0). The fivetaku/awesome-jev fork was cloned at this commit.
- Section: Search, retrieval, and data
- URL: https://www.1kpapers.com/
- Checked: 2026-09-22
...
Jev scores, filters, or picks among passages, rows, or queries the rest of the system already fetched. The list says: 1,018 papers classified by topic and published as a browsable site. Retrieval itself stays a database, index, or crawler. This page did not trace that pipeline.
