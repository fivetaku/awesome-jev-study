...
[한국어](../../ko/projects/199-every-s-editorial-vibe-check.md) · [English](../../en/projects/199-every-s-editorial-vibe-check.md)

- List: [kraayenjon/awesome-jev](https://github.com/kraayenjon/awesome-jev/blob/22570dcd8662ae039860a1dfad7d7aec4aff8e15/README.md#L199) `README.md:199` at `22570dcd` (CC0). The fivetaku/awesome-jev fork was cloned at this commit.
- Section: Featured builds with real numbers
- URL: https://madewithjev.com/builds/every-editorial-judgments
- Checked: 2026-09-22
...
- Numbers printed in the list: 1,709 judgments, <$0.01, 0.35 s median. Author-reported (README.md:209). Not remeasured.

## Role Jev plays

Jev asks the same closed questions of every item in a pile the author already assembled. The list says: 37 documents, 21 questions each; 6 of 7 planted defects caught The figures next to that sentence are author-reported. README.md:209 says the list did not measure them. This study did not either.
