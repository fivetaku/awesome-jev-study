...
[한국어](../../ko/projects/384-customer-support.md) · [English](../../en/projects/384-customer-support.md)

- List: [kraayenjon/awesome-jev](https://github.com/kraayenjon/awesome-jev/blob/22570dcd8662ae039860a1dfad7d7aec4aff8e15/README.md#L384) `README.md:384` at `22570dcd` (CC0). The fivetaku/awesome-jev fork was cloned at this commit.
...
This row is a decision shape, not a repository. The list says: Classify intent, detect urgency and refund intent, score frustration; route with ordinary code and escalate low-confidence tickets. Code is meant to own the branch after the label. No project here was traced, and the use-case map front we fetched did not confirm that the whole sentence matches the map.
