...
[한국어](../../ko/projects/391-e-commerce.md) · [English](../../en/projects/391-e-commerce.md)

- List: [kraayenjon/awesome-jev](https://github.com/kraayenjon/awesome-jev/blob/22570dcd8662ae039860a1dfad7d7aec4aff8e15/README.md#L391) `README.md:391` at `22570dcd` (CC0). The fivetaku/awesome-jev fork was cloned at this commit.
...
This row is a decision shape, not a repository. The list says: Normalize listings, extract product attributes, detect counterfeit or prohibited-listing signals, route exceptions. Code is meant to own the branch after the label. No project here was traced, and the use-case map front we fetched did not confirm that the whole sentence matches the map.
