...
[한국어](../../ko/projects/357-jev-mcp-blakestone-x.md) · [English](../../en/projects/357-jev-mcp-blakestone-x.md)

- List: [kraayenjon/awesome-jev](https://github.com/kraayenjon/awesome-jev/blob/22570dcd8662ae039860a1dfad7d7aec4aff8e15/README.md#L357) `README.md:357` at `22570dcd` (CC0). The fivetaku/awesome-jev fork was cloned at this commit.
...
- Run-confirmed, GitHub API 2026-09-22: `blakestone-x/jev-mcp`, 19 stars, SPDX MIT, push 2026-09-16, archived False, language Python.
- The list's CC0 does not cover this repository. Its license is MIT.
- API description: MCP server for TypeSafe Jev: typed classify, score, check, match and screen for any agent, with confidence on every answer

## Role Jev plays

Jev is exposed as a tool an agent can call, or as a gate in front of an agent that already writes text. The list says: Python MCP server: classify, score, check, match, and screen tools. The agent loop, the permissions, and the side effects are not Jev. This page did not trace them.
