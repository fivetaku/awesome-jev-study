...
[한국어](../../ko/projects/268-more-research-and-data-builds-on-madewithj.md) · [English](../../en/projects/268-more-research-and-data-builds-on-madewithj.md)

- List: [kraayenjon/awesome-jev](https://github.com/kraayenjon/awesome-jev/blob/22570dcd8662ae039860a1dfad7d7aec4aff8e15/README.md#L268) `README.md:268` at `22570dcd` (CC0). The fivetaku/awesome-jev fork was cloned at this commit.
- Section: Search, retrieval, and data
- URL: https://madewithjev.com/categories/research-and-data
- Checked: 2026-09-22
...
Jev scores, filters, or picks among passages, rows, or queries the rest of the system already fetched. The list says: → [More research and data builds on madewithjev.com](https://madewithjev.com/categories/research-and-data) Retrieval itself stays a database, index, or crawler. This page did not trace that pipeline.
