...
[한국어](../../ko/projects/364-pi-jev.md) · [English](../../en/projects/364-pi-jev.md)

- List: [kraayenjon/awesome-jev](https://github.com/kraayenjon/awesome-jev/blob/22570dcd8662ae039860a1dfad7d7aec4aff8e15/README.md#L364) `README.md:364` at `22570dcd` (CC0). The fivetaku/awesome-jev fork was cloned at this commit.
...
- Run-confirmed, GitHub API 2026-09-22: `y0usaf/pi-jev`, 137 stars, SPDX MIT, push 2026-09-22, archived False, language TypeScript.
- The list's CC0 does not cover this repository. Its license is MIT.
- API description: TypeSafe Jev as a decision layer for the Pi coding agent: a measured tool-call gate plus jev_ask for typed, calibrated answers

## Role Jev plays

Jev is exposed as a tool an agent can call, or as a gate in front of an agent that already writes text. The list says: Pi extension with a shadow-mode tool-call gate, output judge, and typed `jev_ask`. The agent loop, the permissions, and the side effects are not Jev. This page did not trace them.
...
The list sentence names: `jev_ask`. That is the list's sentence, not a config file traced in source.
