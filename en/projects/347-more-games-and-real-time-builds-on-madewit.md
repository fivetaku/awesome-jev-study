...
[한국어](../../ko/projects/347-more-games-and-real-time-builds-on-madewit.md) · [English](../../en/projects/347-more-games-and-real-time-builds-on-madewit.md)

- List: [kraayenjon/awesome-jev](https://github.com/kraayenjon/awesome-jev/blob/22570dcd8662ae039860a1dfad7d7aec4aff8e15/README.md#L347) `README.md:347` at `22570dcd` (CC0). The fivetaku/awesome-jev fork was cloned at this commit.
- Section: Demos and games
- URL: https://madewithjev.com/categories/games-and-real-time
- Checked: 2026-09-22
...
Jev's place is the next legal move, chosen from a state the game code rendered as text or as options. The list says: → [More games and real-time builds on madewithjev.com](https://madewithjev.com/categories/games-and-real-time) The game, the legal-move generator, and the input injection sit outside the model. This page did not trace them and did not remeasure author-reported rates or costs.
