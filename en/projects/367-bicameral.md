...
[한국어](../../ko/projects/367-bicameral.md) · [English](../../en/projects/367-bicameral.md)

- List: [kraayenjon/awesome-jev](https://github.com/kraayenjon/awesome-jev/blob/22570dcd8662ae039860a1dfad7d7aec4aff8e15/README.md#L367) `README.md:367` at `22570dcd` (CC0). The fivetaku/awesome-jev fork was cloned at this commit.
...
- Run-confirmed, GitHub API 2026-09-22: `AbdelStark/bicameral`, 5 stars, SPDX MIT, push 2026-09-16, archived False, language TypeScript.
- The list's CC0 does not cover this repository. Its license is MIT.
- API description: Hybrid coding harness: System 2 writes, System 1 (Jev) runs reflexes.

## Role Jev plays

Jev is exposed as a tool an agent can call, or as a gate in front of an agent that already writes text. The list says: Pi coding harness: LLM writes, Jev supplies typed reflexes for policy, loop detection, and review. Explicitly not a sandbox. The agent loop, the permissions, and the side effects are not Jev. This page did not trace them.
