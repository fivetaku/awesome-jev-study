...
- List: [kraayenjon/awesome-jev](https://github.com/kraayenjon/awesome-jev/blob/22570dcd8662ae039860a1dfad7d7aec4aff8e15/README.md#L226) `README.md:226` at `22570dcd` (CC0). The fivetaku/awesome-jev fork was cloned at this commit.
...
- Run-confirmed, GitHub API 2026-09-22: `joshmn/typesafe-sdk`, 6 stars, SPDX MIT, push 2026-09-19, archived False, language Ruby.
- The list's CC0 does not cover this repository. Its license is MIT.
- API description: Ruby client for typesafe.ai

## Role Jev plays

This repository is a client, not the model. Jev stays at the remote System One endpoint. The package is the call in one language. The list's sentence: Ruby 3.1+, retries, thread-safe pooled HTTP. Also [RubyLLM TypeSafe](https://github.com/kieranklaassen/ruby_llm-typesafe) - TypeSafe provider for RubyLLM 2. And [typesafe-ai-rails](https://github.com/GenieRobot/typesafe-ai-rails) - Rails integration with usage telemetry and opt-in confidence policies.
