...
[한국어](../../ko/projects/395-financial-crime.md) · [English](../../en/projects/395-financial-crime.md)

- List: [kraayenjon/awesome-jev](https://github.com/kraayenjon/awesome-jev/blob/22570dcd8662ae039860a1dfad7d7aec4aff8e15/README.md#L395) `README.md:395` at `22570dcd` (CC0). The fivetaku/awesome-jev fork was cloned at this commit.
...
This row is a decision shape, not a repository. The list says: Evaluate transaction narratives and KYC material; match entities and prioritize investigator queues. Code is meant to own the branch after the label. No project here was traced, and the use-case map front we fetched did not confirm that the whole sentence matches the map.
