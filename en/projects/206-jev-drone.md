...
[한국어](../../ko/projects/206-jev-drone.md) · [English](../../en/projects/206-jev-drone.md)

- List: [kraayenjon/awesome-jev](https://github.com/kraayenjon/awesome-jev/blob/22570dcd8662ae039860a1dfad7d7aec4aff8e15/README.md#L206) `README.md:206` at `22570dcd` (CC0). The fivetaku/awesome-jev fork was cloned at this commit.
- Section: Featured builds with real numbers
- URL: https://madewithjev.com/builds/jev-drone
- Checked: 2026-09-22
...
- Numbers printed in the list: control at 2.5 Hz. Author-reported (README.md:209). Not remeasured.

## Role Jev plays

Jev's place is a discrete next action inside a control loop. Motors, setpoints, and safety interlocks are not the model. The list says: Tactical judgment loop flying on hardware This page did not trace the loop and did not remeasure the rate.
