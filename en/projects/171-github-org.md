...
[한국어](../../ko/projects/171-github-org.md) · [English](../../en/projects/171-github-org.md)

- List: [kraayenjon/awesome-jev](https://github.com/kraayenjon/awesome-jev/blob/22570dcd8662ae039860a1dfad7d7aec4aff8e15/README.md#L171) `README.md:171` at `22570dcd` (CC0). The fivetaku/awesome-jev fork was cloned at this commit.
...
- The list calls this 'Official open-source repositories' (README.md:171). An API look at the org on 2026-09-22 also found repositories that are not Jev clients. That inventory is not repeated here.

## Role Jev plays

This row is TypeSafe's own page or the list's own table, not a community integration. What it is for: Official open-source repositories.
