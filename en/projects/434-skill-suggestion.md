...
[한국어](../../ko/projects/434-skill-suggestion.md) · [English](../../en/projects/434-skill-suggestion.md)

- List: [kraayenjon/awesome-jev](https://github.com/kraayenjon/awesome-jev/blob/22570dcd8662ae039860a1dfad7d7aec4aff8e15/README.md#L434) `README.md:434` at `22570dcd` (CC0). The fivetaku/awesome-jev fork was cloned at this commit.
- Section: Cookbooks
...
This row is a recipe. The list says: Rank an agent skill catalog, then read only the top few. The setup, as far as the list goes, is a state plus Choice, Noul, or Score questions, with thresholds left in code. The recipe was not run. Community cookbook code was not copied.
