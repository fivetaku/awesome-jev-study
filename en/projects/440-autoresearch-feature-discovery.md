...
[한국어](../../ko/projects/440-autoresearch-feature-discovery.md) · [English](../../en/projects/440-autoresearch-feature-discovery.md)

- List: [kraayenjon/awesome-jev](https://github.com/kraayenjon/awesome-jev/blob/22570dcd8662ae039860a1dfad7d7aec4aff8e15/README.md#L440) `README.md:440` at `22570dcd` (CC0). The fivetaku/awesome-jev fork was cloned at this commit.
- Section: Cookbooks
...
This row is a recipe. The list says: Propose TypeSafe questions as numeric features for a supervised model. The setup, as far as the list goes, is a state plus Choice, Noul, or Score questions, with thresholds left in code. The recipe was not run. Community cookbook code was not copied.
