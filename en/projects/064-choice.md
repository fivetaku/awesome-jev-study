...
- List: [kraayenjon/awesome-jev](https://github.com/kraayenjon/awesome-jev/blob/22570dcd8662ae039860a1dfad7d7aec4aff8e15/README.md#L64) `README.md:64` at `22570dcd` (CC0). The fivetaku/awesome-jev fork was cloned at this commit.
- Section: What is Jev?
...
- Numbers printed in the list: `choice`, `probabilities`, `confidence`. Author-reported (README.md:209). Not remeasured.

## Role Jev plays

This row is one question type, not a third-party app. Jev's role is the question itself: Pick one option from a list Choice picks one option you listed. Score places the state on a rubric. Noul answers whether a statement holds, as a number from 0 to 1. The list says questions in one request run in parallel against the same state (README.md:60).
