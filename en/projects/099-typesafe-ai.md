...
[한국어](../../ko/projects/099-typesafe-ai.md) · [English](../../en/projects/099-typesafe-ai.md)

- List: [kraayenjon/awesome-jev](https://github.com/kraayenjon/awesome-jev/blob/22570dcd8662ae039860a1dfad7d7aec4aff8e15/README.md#L99) `README.md:99` at `22570dcd` (CC0). The fivetaku/awesome-jev fork was cloned at this commit.
...
This row is TypeSafe's own page or the list's own table, not a community integration. What it is for: Early access via waitlist at [typesafe.ai](https://typesafe.ai)
