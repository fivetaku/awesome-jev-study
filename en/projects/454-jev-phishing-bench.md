...
- List: [kraayenjon/awesome-jev](https://github.com/kraayenjon/awesome-jev/blob/22570dcd8662ae039860a1dfad7d7aec4aff8e15/README.md#L454) `README.md:454` at `22570dcd` (CC0). The fivetaku/awesome-jev fork was cloned at this commit.
...
- Run-confirmed, GitHub API 2026-09-22: `anisselbd/jev-phishing-bench`, 3 stars, SPDX none, push 2026-09-19, archived False, language Python.
- API description: Jev (TypeSafe) vs Claude Haiku 4.5 on 2 000 phishing emails: accuracy, calibration, latency, cost. Reproducible benchmark.

## Role Jev plays

This row is a harness or a published eval, not a product feature. The list says: 2,000 emails: Jev vs Claude Haiku 4.5 on click-or-not, with calibration, latency, and cost. Haiku wins accuracy here. Official numbers on the list are vendor-reported. This study did not rerun the harness. A fetch of evals.typesafe.ai on 2026-09-22 did not contain the headline percentages an earlier, longer extract had quoted, so those percentages are not restated here.
