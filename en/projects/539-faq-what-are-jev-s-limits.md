...
- List: [kraayenjon/awesome-jev](https://github.com/kraayenjon/awesome-jev/blob/22570dcd8662ae039860a1dfad7d7aec4aff8e15/README.md#L539) `README.md:539` at `22570dcd` (CC0). The fivetaku/awesome-jev fork was cloned at this commit.
- Section: FAQ
...
This row is not a Jev integration. It is a page, a post, a list, or a FAQ answer about Jev. The list says: Choice questions cap at 255 options. Text only — no images, audio, or video. Listed rate limits are 250,000 tokens/second and 1,200 requests/minute, and TypeSafe says they can change dynamically. Known failure modes of the current model are documented in [Jev 1.13 jaggedness](https://docs.typesafe.ai/model-jaggedness/jev-1.13). There is no call setup to recover from a front matter that is not a project. Social text is not treated as a verified fact.
