...
[한국어](../../ko/projects/485-jev-sorted.md) · [English](../../en/projects/485-jev-sorted.md)

- List: [kraayenjon/awesome-jev](https://github.com/kraayenjon/awesome-jev/blob/22570dcd8662ae039860a1dfad7d7aec4aff8e15/README.md#L485) `README.md:485` at `22570dcd` (CC0). The fivetaku/awesome-jev fork was cloned at this commit.
...
This row is not a Jev integration. It is a page, a post, a list, or a FAQ answer about Jev. The list says: What the launch claims survive a reading of the primary sources, and what is still vendor-reported. There is no call setup to recover from a front matter that is not a project. Social text is not treated as a verified fact.
