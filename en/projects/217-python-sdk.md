...
- List: [kraayenjon/awesome-jev](https://github.com/kraayenjon/awesome-jev/blob/22570dcd8662ae039860a1dfad7d7aec4aff8e15/README.md#L217) `README.md:217` at `22570dcd` (CC0). The fivetaku/awesome-jev fork was cloned at this commit.
...
- Run-confirmed, GitHub API 2026-09-22: `typesafe-ai/typesafe-sdk-python`, 198 stars, SPDX MIT, push 2026-09-21, archived False, language Python.
- The list's CC0 does not cover this repository. Its license is MIT.
- API description: The official Python library for the TypeSafe API

## Role Jev plays

This repository is a client, not the model. Jev stays at the remote System One endpoint. The package is the call in one language. The list's sentence: `pip install typesafe-sdk`. [Docs](https://docs.typesafe.ai/sdk/python).
...
The list sentence names: `pip install typesafe-sdk`. That is the list's sentence, not a config file traced in source.
