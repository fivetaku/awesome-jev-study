...
[한국어](../../ko/projects/175-the-bitterest-lesson.md) · [English](../../en/projects/175-the-bitterest-lesson.md)

- List: [kraayenjon/awesome-jev](https://github.com/kraayenjon/awesome-jev/blob/22570dcd8662ae039860a1dfad7d7aec4aff8e15/README.md#L175) `README.md:175` at `22570dcd` (CC0). The fivetaku/awesome-jev fork was cloned at this commit.
...
- Sentence present in this fetch: doing the right task ranks ahead of data, data ahead of compute, compute ahead of algorithms. The TL;DR is that compute does not help if the task is wrong. No author name in the extract. The date chrome is 2026-09-10.

## Role Jev plays

This row is TypeSafe's own page or the list's own table, not a community integration. What it is for: Why optimizing the wrong task can dominate gains from scale.
