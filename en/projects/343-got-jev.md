...
- List: [kraayenjon/awesome-jev](https://github.com/kraayenjon/awesome-jev/blob/22570dcd8662ae039860a1dfad7d7aec4aff8e15/README.md#L343) `README.md:343` at `22570dcd` (CC0). The fivetaku/awesome-jev fork was cloned at this commit.
...
- Run-confirmed, GitHub API 2026-09-22: `phureewat29/jev-got`, 2 stars, SPDX none, push 2026-09-19, archived False, language TypeScript.
- API description: Jev (TypeSafe AI) PoC through Game of Thrones

## Role Jev plays

Jev's place is the next legal move, chosen from a state the game code rendered as text or as options. The list says: Game of Thrones roleplay: a story model writes the scene; Jev answers where Jon Snow is, how much danger, and what should play under it. The game, the legal-move generator, and the input injection sit outside the model. This page did not trace them and did not remeasure author-reported rates or costs.
