...
- List: [kraayenjon/awesome-jev](https://github.com/kraayenjon/awesome-jev/blob/22570dcd8662ae039860a1dfad7d7aec4aff8e15/README.md#L277) `README.md:277` at `22570dcd` (CC0). The fivetaku/awesome-jev fork was cloned at this commit.
...
- Run-confirmed, GitHub API 2026-09-22: `teyhouse/jev-secret-detection`, 0 stars, SPDX none, push 2026-09-18, archived False, language Python.
- API description: Measures how well TypeSafe's RLCD-Jev model spots real secret credentials in file snippets

## Role Jev plays

The list says: Secret-in-diff detector with repeatable Jev verdicts. Rows filed in this section are usually a judgment over a diff, a log, a commit, or a string already extracted, and ordinary code keeps the filesystem and the git calls. That is the section's shape. It is not a finding that this row matches it. This page did not trace the code.
