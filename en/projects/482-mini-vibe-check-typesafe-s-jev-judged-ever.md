...
[한국어](../../ko/projects/482-mini-vibe-check-typesafe-s-jev-judged-ever.md) · [English](../../en/projects/482-mini-vibe-check-typesafe-s-jev-judged-ever.md)

- List: [kraayenjon/awesome-jev](https://github.com/kraayenjon/awesome-jev/blob/22570dcd8662ae039860a1dfad7d7aec4aff8e15/README.md#L482) `README.md:482` at `22570dcd` (CC0). The fivetaku/awesome-jev fork was cloned at this commit.
- Section: Articles and coverage
...
- The 2026-09-22 fetch was a login wall. The post body was not read.

## Role Jev plays

This row is not a Jev integration. It is a page, a post, a list, or a FAQ answer about Jev. The list says: Every's Mike Taylor runs Jev over his writing corpus: 1,709 judgments for under a cent. There is no call setup to recover from a front matter that is not a project. Social text is not treated as a verified fact.
