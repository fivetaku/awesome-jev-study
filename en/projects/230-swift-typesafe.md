...
[한국어](../../ko/projects/230-swift-typesafe.md) · [English](../../en/projects/230-swift-typesafe.md)

- List: [kraayenjon/awesome-jev](https://github.com/kraayenjon/awesome-jev/blob/22570dcd8662ae039860a1dfad7d7aec4aff8e15/README.md#L230) `README.md:230` at `22570dcd` (CC0). The fivetaku/awesome-jev fork was cloned at this commit.
...
- Run-confirmed, GitHub API 2026-09-22: `ainame/swift-typesafe`, 14 stars, SPDX MIT, push 2026-09-20, archived False, language Swift.
- The list's CC0 does not cover this repository. Its license is MIT.
- API description: Unofficial Swift SDK for TypeSafe

## Role Jev plays

This repository is a client, not the model. Jev stays at the remote System One endpoint. The package is the call in one language. The list's sentence: Swift 6.4 client aligned with the Python SDK 0.6.0 API, including Linux.
