...
[한국어](../../ko/projects/486-typesafe-jev-played-chess-and-landed-next-.md) · [English](../../en/projects/486-typesafe-jev-played-chess-and-landed-next-.md)

- List: [kraayenjon/awesome-jev](https://github.com/kraayenjon/awesome-jev/blob/22570dcd8662ae039860a1dfad7d7aec4aff8e15/README.md#L486) `README.md:486` at `22570dcd` (CC0). The fivetaku/awesome-jev fork was cloned at this commit.
...
This row is not a Jev integration. It is a page, a post, a list, or a FAQ answer about Jev. The list says: Maxim Saplin constrains chess to legal-move Choices. There is no call setup to recover from a front matter that is not a project. Social text is not treated as a verified fact.
