...
[한국어](../../ko/projects/168-http-api-reference.md) · [English](../../en/projects/168-http-api-reference.md)

- List: [kraayenjon/awesome-jev](https://github.com/kraayenjon/awesome-jev/blob/22570dcd8662ae039860a1dfad7d7aec4aff8e15/README.md#L168) `README.md:168` at `22570dcd` (CC0). The fivetaku/awesome-jev fork was cloned at this commit.
...
This row is TypeSafe's own page or the list's own table, not a community integration. What it is for: `POST https://api.typesafe.ai/v1/systemone`.
...
The list sentence names: `POST https://api.typesafe.ai/v1/systemone`. That is the list's sentence, not a config file traced in source.
