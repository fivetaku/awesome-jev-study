...
- List: [kraayenjon/awesome-jev](https://github.com/kraayenjon/awesome-jev/blob/22570dcd8662ae039860a1dfad7d7aec4aff8e15/README.md#L461) `README.md:461` at `22570dcd` (CC0). The fivetaku/awesome-jev fork was cloned at this commit.
...
- Run-confirmed, GitHub API 2026-09-22: `vclic/smoking-extraction-benchmark`, 0 stars, SPDX none, push 2026-09-18, archived False, language Python.
- API description: Synthetic smoking-history extraction benchmark comparing TypeSafe Jev and OpenAI structured outputs, with reproducible accuracy, cost, and latency results.

## Role Jev plays

This row is a harness or a published eval, not a product feature. The list says: 1,000 synthetic notes: Jev vs OpenAI structured outputs on accuracy, cost, and latency. Official numbers on the list are vendor-reported. This study did not rerun the harness. A fetch of evals.typesafe.ai on 2026-09-22 did not contain the headline percentages an earlier, longer extract had quoted, so those percentages are not restated here.
