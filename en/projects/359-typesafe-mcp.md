...
[한국어](../../ko/projects/359-typesafe-mcp.md) · [English](../../en/projects/359-typesafe-mcp.md)

- List: [kraayenjon/awesome-jev](https://github.com/kraayenjon/awesome-jev/blob/22570dcd8662ae039860a1dfad7d7aec4aff8e15/README.md#L359) `README.md:359` at `22570dcd` (CC0). The fivetaku/awesome-jev fork was cloned at this commit.
...
- Run-confirmed, GitHub API 2026-09-22: `itsmostafa/typesafe-mcp`, 251 stars, SPDX MIT, push 2026-09-21, archived False, language Go.
- The list's CC0 does not cover this repository. Its license is MIT.
- API description: mcp connector to give your AI agent direct access to typesafe ai's jev model

## Role Jev plays

Jev is exposed as a tool an agent can call, or as a gate in front of an agent that already writes text. The list says: Go CLI and single-binary MCP for Claude Desktop, Claude Code, and Codex. The agent loop, the permissions, and the side effects are not Jev. This page did not trace them.
