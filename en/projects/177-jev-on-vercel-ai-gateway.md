...
- List: [kraayenjon/awesome-jev](https://github.com/kraayenjon/awesome-jev/blob/22570dcd8662ae039860a1dfad7d7aec4aff8e15/README.md#L177) `README.md:177` at `22570dcd` (CC0). The fivetaku/awesome-jev fork was cloned at this commit.
...
This row is TypeSafe's own page or the list's own table, not a community integration. What it is for: Hosted `typesafe-ai/jev` for the AI SDK's `experimental_evaluate`, no TypeSafe waitlist required.
