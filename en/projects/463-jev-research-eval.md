...
- List: [kraayenjon/awesome-jev](https://github.com/kraayenjon/awesome-jev/blob/22570dcd8662ae039860a1dfad7d7aec4aff8e15/README.md#L463) `README.md:463` at `22570dcd` (CC0). The fivetaku/awesome-jev fork was cloned at this commit.
...
- Run-confirmed, GitHub API 2026-09-22: `jgridifier/jev-research-eval`, 2 stars, SPDX NOASSERTION, push 2026-09-17, archived False, language HTML.
- The list's CC0 does not cover this repository. Its license is NOASSERTION.
- API description: Reproducible Jev Ultrafast research-browser eval harness + field note (QC’d cases, suite runner, report generator). Not investment advice.

## Role Jev plays

This row is a harness or a published eval, not a product feature. The list says: Reproducible eval harness plus field note for Jev Ultrafast research-browser tasks. Official numbers on the list are vendor-reported. This study did not rerun the harness. A fetch of evals.typesafe.ai on 2026-09-22 did not contain the headline percentages an earlier, longer extract had quoted, so those percentages are not restated here.
