...
- List: [kraayenjon/awesome-jev](https://github.com/kraayenjon/awesome-jev/blob/22570dcd8662ae039860a1dfad7d7aec4aff8e15/README.md#L264) `README.md:264` at `22570dcd` (CC0). The fivetaku/awesome-jev fork was cloned at this commit.
...
- Run-confirmed, GitHub API 2026-09-22: `AkashPriyadarshii/jev-curate`, 23 stars, SPDX MIT, push 2026-09-22, archived False, language Rust.
- The list's CC0 does not cover this repository. Its license is MIT.
- API description: High-throughput synthetic and pretraining dataset sifter for TypeSafe Jev. Rust streaming core, Parquet and JSONL I/O, typed Choice/Score/Noul judgments, speculative fan-out, 24.0

## Role Jev plays

Jev scores, filters, or picks among passages, rows, or queries the rest of the system already fetched. The list says: High-throughput synthetic dataset sifter in Rust: Noul checks on JSONL and Parquet rows, streaming clean and rejected rows to disk. Retrieval itself stays a database, index, or crawler. This page did not trace that pipeline.
