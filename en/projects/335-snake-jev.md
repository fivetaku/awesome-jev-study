...
- List: [kraayenjon/awesome-jev](https://github.com/kraayenjon/awesome-jev/blob/22570dcd8662ae039860a1dfad7d7aec4aff8e15/README.md#L335) `README.md:335` at `22570dcd` (CC0). The fivetaku/awesome-jev fork was cloned at this commit.
...
- Run-confirmed, GitHub API 2026-09-22: `siroccomask/snake-jev`, 0 stars, SPDX MIT, push 2026-09-19, archived False, language Python.
- The list's CC0 does not cover this repository. Its license is MIT.
- API description: Snake controlled by parallel Jev assessments, with one API call per game tick.

## Role Jev plays

Jev's place is the next legal move, chosen from a state the game code rendered as text or as options. The list says: Snake: hundreds of typed direction decisions per run. Also [typesafe-snake](https://github.com/sorrycc/typesafe-snake). The game, the legal-move generator, and the input injection sit outside the model. This page did not trace them and did not remeasure author-reported rates or costs.
