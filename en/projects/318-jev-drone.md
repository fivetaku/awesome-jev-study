...
- List: [kraayenjon/awesome-jev](https://github.com/kraayenjon/awesome-jev/blob/22570dcd8662ae039860a1dfad7d7aec4aff8e15/README.md#L318) `README.md:318` at `22570dcd` (CC0). The fivetaku/awesome-jev fork was cloned at this commit.
...
- Run-confirmed, GitHub API 2026-09-22: `RomanSlack/jev-drone`, 127 stars, SPDX MIT, push 2026-09-21, archived False, language Python.
- The list's CC0 does not cover this repository. Its license is MIT.
- API description: Camera-only autonomous drone in MuJoCo with a small judgment model (TypeSafe Jev) in the loop at 2.5Hz

## Role Jev plays

Jev's place is a discrete next action inside a control loop. Motors, setpoints, and safety interlocks are not the model. The list says: MuJoCo quadrotor: control and safety stay in code; Jev handles slower tactical judgments at 2.5 Hz. This page did not trace the loop and did not remeasure the rate.
