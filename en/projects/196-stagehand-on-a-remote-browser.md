...
[한국어](../../ko/projects/196-stagehand-on-a-remote-browser.md) · [English](../../en/projects/196-stagehand-on-a-remote-browser.md)

- List: [kraayenjon/awesome-jev](https://github.com/kraayenjon/awesome-jev/blob/22570dcd8662ae039860a1dfad7d7aec4aff8e15/README.md#L196) `README.md:196` at `22570dcd` (CC0). The fivetaku/awesome-jev fork was cloned at this commit.
- Section: Featured builds with real numbers
- URL: https://madewithjev.com/builds/stagehand-remote-browser
- Checked: 2026-09-22
...
- Numbers printed in the list: ~$0.001/task. Author-reported (README.md:209). Not remeasured.

## Role Jev plays

Jev's place, if the list is right, is the decision inside a browser or computer-use loop. The list says: Browser tasks at a tenth of a cent each Observing the page and performing the click are ordinary code. This page did not trace that loop, and it does not claim this project sees pixels. The Doom write-up is the one that says text state rather than frames, and that sentence is not copied onto other agents.
