...
[한국어](../../ko/projects/433-function-calling.md) · [English](../../en/projects/433-function-calling.md)

- List: [kraayenjon/awesome-jev](https://github.com/kraayenjon/awesome-jev/blob/22570dcd8662ae039860a1dfad7d7aec4aff8e15/README.md#L433) `README.md:433` at `22570dcd` (CC0). The fivetaku/awesome-jev fork was cloned at this commit.
- Section: Cookbooks
...
This row is a recipe. The list says: Map natural-language requests onto ordinary typed functions with closed-set arguments. The setup, as far as the list goes, is a state plus Choice, Noul, or Score questions, with thresholds left in code. The recipe was not run. Community cookbook code was not copied.
