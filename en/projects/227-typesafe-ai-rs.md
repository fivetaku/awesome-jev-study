...
- List: [kraayenjon/awesome-jev](https://github.com/kraayenjon/awesome-jev/blob/22570dcd8662ae039860a1dfad7d7aec4aff8e15/README.md#L227) `README.md:227` at `22570dcd` (CC0). The fivetaku/awesome-jev fork was cloned at this commit.
...
- Run-confirmed, GitHub API 2026-09-22: `gilljon/typesafe-ai-rs`, 4 stars, SPDX MIT, push 2026-09-17, archived False, language Rust.
- The list's CC0 does not cover this repository. Its license is MIT.
- API description: Independent async and blocking Rust SDK for the TypeSafe AI System One API

## Role Jev plays

This repository is a client, not the model. Jev stays at the remote System One endpoint. The package is the call in one language. The list's sentence: async and blocking client. Also [Twister915/typesafe-ai](https://github.com/Twister915/typesafe-ai) - observable retries; [typesafe-rs](https://github.com/AbdelStark/typesafe-rs) - latency-focused transport; [s1-rs](https://github.com/AbdelStark/s1-rs) - derive layer for Choice / Score / Noul with confidence gates and network-free tests.
