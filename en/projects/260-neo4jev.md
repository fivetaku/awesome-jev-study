...
- List: [kraayenjon/awesome-jev](https://github.com/kraayenjon/awesome-jev/blob/22570dcd8662ae039860a1dfad7d7aec4aff8e15/README.md#L260) `README.md:260` at `22570dcd` (CC0). The fivetaku/awesome-jev fork was cloned at this commit.
...
- Run-confirmed, GitHub API 2026-09-22: `jexp/neo4jev`, 85 stars, SPDX MIT, push 2026-09-18, archived False, language Jupyter Notebook.
- The list's CC0 does not cover this repository. Its license is MIT.
- API description: Typesafe.ai System One Model Jev navigating a Neo4j graph by using a classifier over neighbouring relationships

## Role Jev plays

Jev scores, filters, or picks among passages, rows, or queries the rest of the system already fetched. The list says: Neo4j graph navigation: at each node Jev chooses which relationship to follow, with beam search over log-probabilities. Retrieval itself stays a database, index, or crawler. This page did not trace that pipeline.
