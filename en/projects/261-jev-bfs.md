...
- List: [kraayenjon/awesome-jev](https://github.com/kraayenjon/awesome-jev/blob/22570dcd8662ae039860a1dfad7d7aec4aff8e15/README.md#L261) `README.md:261` at `22570dcd` (CC0). The fivetaku/awesome-jev fork was cloned at this commit.
...
- Run-confirmed, GitHub API 2026-09-22: `komikat/jev-bfs`, 0 stars, SPDX MIT, push 2026-09-17, archived False, language Python.
- The list's CC0 does not cover this repository. Its license is MIT.
- API description: Wikipedia link races with direct Jev ranking and a live terminal display.

## Role Jev plays

Jev scores, filters, or picks among passages, rows, or queries the rest of the system already fetched. The list says: Finds link paths between Wikipedia articles; Jev ranks each page's outgoing links while Python controls the search. Retrieval itself stays a database, index, or crawler. This page did not trace that pipeline.
