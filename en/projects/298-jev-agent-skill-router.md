...
[한국어](../../ko/projects/298-jev-agent-skill-router.md) · [English](../../en/projects/298-jev-agent-skill-router.md)

- List: [kraayenjon/awesome-jev](https://github.com/kraayenjon/awesome-jev/blob/22570dcd8662ae039860a1dfad7d7aec4aff8e15/README.md#L298) `README.md:298` at `22570dcd` (CC0). The fivetaku/awesome-jev fork was cloned at this commit.
...
- Run-confirmed, GitHub API 2026-09-22: `GodsBoy/jev-agent-skill-router`, 16 stars, SPDX MIT, push 2026-09-16, archived False, language Python.
- The list's CC0 does not cover this repository. Its license is MIT.
- API description: Typed, confidence-aware agent skill routing with TypeSafe Jev.

## Role Jev plays

Jev's Choice picks the next model, skill, or route. Generation, if any, happens after that pick. The list says: Routes agent skill selection through typed, confidence-aware decisions so weak matches are declined instead of guessed. This page did not trace the routing rule in source.
