...
- 목록: [kraayenjon/awesome-jev](https://github.com/kraayenjon/awesome-jev/blob/22570dcd8662ae039860a1dfad7d7aec4aff8e15/README.md#L322) `README.md:322` @ `22570dcd` (CC0). fivetaku/awesome-jev 포크는 이 커밋으로 클론했다.
- 절: 로봇·하드웨어
- 주소: https://madewithjev.com/categories/robotics-and-devices
- 조회: 2026-09-22
...
→ [madewithjev.com의 로봇과 장치](https://madewithjev.com/categories/robotics-and-devices)
...
Jev의 자리는 제어 루프 안의 이산적인 다음 행동이다. 모터, 설정값, 안전 인터록은 모델이 아니다. 목록은 이렇게 적는다. → [madewithjev.com의 로봇과 장치](https://madewithjev.com/categories/robotics-and-devices) 이 페이지는 루프를 따라가지 않았고 주기를 재측정하지 않았다.
