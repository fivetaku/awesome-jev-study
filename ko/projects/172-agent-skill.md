...
[한국어](../../ko/projects/172-agent-skill.md) · [English](../../en/projects/172-agent-skill.md)

- 목록: [kraayenjon/awesome-jev](https://github.com/kraayenjon/awesome-jev/blob/22570dcd8662ae039860a1dfad7d7aec4aff8e15/README.md#L172) `README.md:172` @ `22570dcd` (CC0). fivetaku/awesome-jev 포크는 이 커밋으로 클론했다.
- 절: 공식 자료
- 주소: https://docs.typesafe.ai/agent-skill
- 조회: 2026-09-22
...
Claude Code, Codex, 그 밖의 코딩 에이전트에 넣는 스킬. [typesafe-ai/skills](https://github.com/typesafe-ai/skills).
...
이 행은 커뮤니티 통합이 아니라 TypeSafe 페이지이거나 목록 자신의 표다. 다루는 것: Claude Code, Codex, 그 밖의 코딩 에이전트에 넣는 스킬. [typesafe-ai/skills](https://github.com/typesafe-ai/skills).
