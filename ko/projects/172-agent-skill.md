...
이 행은 커뮤니티 통합이 아니라 TypeSafe 페이지이거나 목록 자신의 표다. 다루는 것: Drop-in skill for Claude Code, Codex, and other coding agents ([typesafe-ai/skills](https://github.com/typesafe-ai/skills)).
