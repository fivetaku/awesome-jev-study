...
- 목록: [kraayenjon/awesome-jev](https://github.com/kraayenjon/awesome-jev/blob/22570dcd8662ae039860a1dfad7d7aec4aff8e15/README.md#L355) `README.md:355` @ `22570dcd` (CC0). fivetaku/awesome-jev 포크는 이 커밋으로 클론했다.
- 절: 에이전트 도구·MCP
- 주소: https://github.com/vercel-labs/ai-cli
- 조회: 2026-09-22
...
Vercel Labs CLI. `evaluate`의 평가 모델로 Jev를 돌릴 수 있다.

## 확인한 것

- 실행으로 확인, GitHub API 2026-09-22: `vercel-labs/ai-cli`, 스타 811, SPDX none, push 2026-09-19, 아카이브 False, 언어 TypeScript.
- API 설명 한 줄: Generate anything from your terminal

## Jev의 역할

Jev는 에이전트가 부르는 도구로 열려 있거나, 이미 문장을 쓰는 에이전트 앞의 게이트다. 목록은 이렇게 적는다. Vercel Labs CLI. `evaluate`의 평가 모델로 Jev를 돌릴 수 있다. 에이전트 루프, 권한, 그 다음 일은 Jev가 아니다. 이 페이지는 그것들을 따라가지 않았다.
