...
- 목록: [kraayenjon/awesome-jev](https://github.com/kraayenjon/awesome-jev/blob/22570dcd8662ae039860a1dfad7d7aec4aff8e15/README.md#L233) `README.md:233` @ `22570dcd` (CC0). fivetaku/awesome-jev 포크는 이 커밋으로 클론했다.
- 절: SDKs and clients (SDK와 클라이언트)
- 주소: https://github.com/pithings/advocaat
- 조회: 2026-09-22
...
- 실행으로 확인, GitHub API 2026-09-22: `pithings/advocaat`, 스타 89, SPDX MIT, push 2026-09-18, 아카이브 False, 언어 TypeScript.
- 목록의 CC0은 이 저장소 코드에 미치지 않는다. 라이선스는 MIT이다.
- API 설명 한 줄: A small, type-safe client for asking AI questions about your data, powered by TypeSafe Jev.

## Jev의 역할

이 저장소는 모델이 아니라 클라이언트다. Jev는 원격 System One 엔드포인트에 있다. 패키지는 그 호출을 한 언어로 적게 해 준다. 목록 문장: small client with tagged helpers for chances, choices, and scores.
