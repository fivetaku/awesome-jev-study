...
[한국어](../../ko/projects/207-wikiracing.md) · [English](../../en/projects/207-wikiracing.md)

- 목록: [kraayenjon/awesome-jev](https://github.com/kraayenjon/awesome-jev/blob/22570dcd8662ae039860a1dfad7d7aec4aff8e15/README.md#L207) `README.md:207` @ `22570dcd` (CC0). fivetaku/awesome-jev 포크는 이 커밋으로 클론했다.
- 절: Featured builds with real numbers (숫자가 붙은 빌드)
- 주소: https://madewithjev.com/builds/wikiracing
- 조회: 2026-09-22
...
- 목록이 같이 적은 숫자: 255-option Choice ceiling. 저자 보고이다 (README.md:209). 재측정하지 않았다.

## Jev의 역할

Jev의 자리는 다음 합법 수다. 게임 코드가 상태나 선택지로 만들어 넘긴 것 중에서 고른다. 목록은 이렇게 적는다. Pick one link out of thousands until you arrive 게임, 합법 수 생성, 입력 주입은 모델 밖에 있다. 이 페이지는 그것들을 따라가지 않았고, 저자가 보고한 속도·비용을 재측정하지 않았다.
