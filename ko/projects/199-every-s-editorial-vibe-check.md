...
- 목록: [kraayenjon/awesome-jev](https://github.com/kraayenjon/awesome-jev/blob/22570dcd8662ae039860a1dfad7d7aec4aff8e15/README.md#L199) `README.md:199` @ `22570dcd` (CC0). fivetaku/awesome-jev 포크는 이 커밋으로 클론했다.
- 절: 숫자가 붙은 빌드
- 주소: https://madewithjev.com/builds/every-editorial-judgments
- 조회: 2026-09-22
...
문서 37개, 문서마다 질문 21개. 심어 둔 결함 7개 중 6개를 잡았다고 목록이 적는다.

## 확인한 것

- 목록이 같이 적은 숫자: 1,709 judgments, <$0.01, 0.35 s median. 저자 보고이다 (README.md:209). 재측정하지 않았다.

## Jev의 역할

Jev는 저자가 이미 모아 둔 더미의 모든 항목에 같은 닫힌 질문을 한다. 목록은 이렇게 적는다. 문서 37개, 문서마다 질문 21개. 심어 둔 결함 7개 중 6개를 잡았다고 목록이 적는다. 그 문장 옆의 숫자는 저자 보고다. README.md:209는 목록이 재지 않았다고 적는다. 이 스터디도 재지 않았다.
