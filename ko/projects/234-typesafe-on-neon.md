...
- 목록: [kraayenjon/awesome-jev](https://github.com/kraayenjon/awesome-jev/blob/22570dcd8662ae039860a1dfad7d7aec4aff8e15/README.md#L234) `README.md:234` @ `22570dcd` (CC0). fivetaku/awesome-jev 포크는 이 커밋으로 클론했다.
- 절: SDK와 클라이언트
- 주소: https://github.com/andrelandgraf/typesafe-on-neon
- 조회: 2026-09-22
...
Neon AI Gateway용 Neon Function 프록시.

## 확인한 것

- 실행으로 확인, GitHub API 2026-09-22: `andrelandgraf/safer-with-jev`, 스타 4, SPDX none, push 2026-09-18, 아카이브 False, 언어 TypeScript.
- API 설명 한 줄: Neon Function proxy for the Neon AI Gateway with TypeSafe Jev routing.

## Jev의 역할

이 저장소는 모델이 아니라 클라이언트다. Jev는 원격 System One 엔드포인트에 있다. 패키지는 그 호출을 한 언어로 적게 해 준다. 목록 문장: Neon AI Gateway용 Neon Function 프록시.
