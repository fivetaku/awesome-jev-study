...
[한국어](../../ko/projects/463-jev-research-eval.md) · [English](../../en/projects/463-jev-research-eval.md)

- 목록: [kraayenjon/awesome-jev](https://github.com/kraayenjon/awesome-jev/blob/22570dcd8662ae039860a1dfad7d7aec4aff8e15/README.md#L463) `README.md:463` @ `22570dcd` (CC0). fivetaku/awesome-jev 포크는 이 커밋으로 클론했다.
- 절: 벤치마크
- 주소: https://github.com/jgridifier/jev-research-eval
- 조회: 2026-09-22
...
Jev Ultrafast의 연구용 브라우저 과제를 위한 재현 가능한 평가 하네스와 현장 노트.

## 확인한 것

- 실행으로 확인, GitHub API 2026-09-22: `jgridifier/jev-research-eval`, 스타 2, SPDX NOASSERTION, push 2026-09-17, 아카이브 False, 언어 HTML.
- 목록의 CC0은 이 저장소 코드에 미치지 않는다. 라이선스는 NOASSERTION이다.
- API 설명 한 줄: Reproducible Jev Ultrafast research-browser eval harness + field note (QC’d cases, suite runner, report generator). Not investment advice.

## Jev의 역할

이 행은 제품 기능이 아니라 하네스이거나 공개 평가다. 목록은 이렇게 적는다. Jev Ultrafast의 연구용 브라우저 과제를 위한 재현 가능한 평가 하네스와 현장 노트. 목록의 공식 숫자는 벤더 보고다. 이 스터디는 하네스를 다시 돌리지 않았다. 2026-09-22의 evals.typesafe.ai 조회 본문에는, 더 긴 이전 추출이 인용하던 대표 백분율이 없었다. 그래서 그 백분율은 여기 다시 적지 않는다.
