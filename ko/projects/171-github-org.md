...
- 목록: [kraayenjon/awesome-jev](https://github.com/kraayenjon/awesome-jev/blob/22570dcd8662ae039860a1dfad7d7aec4aff8e15/README.md#L171) `README.md:171` @ `22570dcd` (CC0). fivetaku/awesome-jev 포크는 이 커밋으로 클론했다.
- 절: 공식 자료
- 주소: https://github.com/typesafe-ai
- 조회: 2026-09-22
...
공식 오픈소스 저장소라고 목록이 적는다. 이 스터디는 그 조직이 섞여 있는지를 여기서 다시 단정하지 않는다.

## 확인한 것

- 목록은 여기를 'Official open-source repositories'라고 부른다 (README.md:171). 2026-09-22 API로 본 조직에는 Jev 클라이언트가 아닌 저장소도 있었다. 그 목록을 여기 다시 옮기지는 않는다.

## Jev의 역할

이 행은 커뮤니티 통합이 아니라 TypeSafe 페이지이거나 목록 자신의 표다. 다루는 것: 공식 오픈소스 저장소라고 목록이 적는다. 이 스터디는 그 조직이 섞여 있는지를 여기서 다시 단정하지 않는다.
