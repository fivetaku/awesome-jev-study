...
- 실행으로 확인, GitHub API 2026-09-22: `prismhq/jev-router`, 스타 8, SPDX MIT, push 2026-09-17, 아카이브 False, 언어 Python.
- 목록의 CC0은 이 저장소 코드에 미치지 않는다. 라이선스는 MIT이다.
- API 설명 한 줄: Open-source LLM router that uses TypeSafe's Jev to pick a model, on top of LiteLLM
