...
DSPy 동반 도구. TypeSafe 호출을 기록하고 재생하면서 보정, 선택적 위험, 기권, 지연, 비용을 잰다.
...
이 행은 제품 기능이 아니라 하네스이거나 공개 평가다. 목록은 이렇게 적는다. DSPy 동반 도구. TypeSafe 호출을 기록하고 재생하면서 보정, 선택적 위험, 기권, 지연, 비용을 잰다. 목록의 공식 숫자는 벤더 보고다. 이 스터디는 하네스를 다시 돌리지 않았다. 2026-09-22의 evals.typesafe.ai 조회 본문에는, 더 긴 이전 추출이 인용하던 대표 백분율이 없었다. 그래서 그 백분율은 여기 다시 적지 않는다.
