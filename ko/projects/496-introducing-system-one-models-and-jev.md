...
- 목록: [kraayenjon/awesome-jev](https://github.com/kraayenjon/awesome-jev/blob/22570dcd8662ae039860a1dfad7d7aec4aff8e15/README.md#L496) `README.md:496` @ `22570dcd` (CC0). fivetaku/awesome-jev 포크는 이 커밋으로 클론했다.
- 절: 토론·소셜
- 주소: https://news.ycombinator.com/item?id=49717558
- 조회: 2026-09-22
...
점수 1,800의 Hacker News 공개 스레드. 벤치마크를 의심하는 읽기는 여기에 있다.
...
이 행은 Jev 통합이 아니다. Jev에 대한 페이지, 글, 목록, FAQ 답이다. 목록은 이렇게 적는다. 점수 1,800의 Hacker News 공개 스레드. 벤치마크를 의심하는 읽기는 여기에 있다. 프로젝트가 아닌 앞부분에서 복구할 호출 설정은 없다. 소셜 글의 문장은 확인된 사실로 취급하지 않는다.
