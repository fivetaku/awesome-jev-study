...
[한국어](../../ko/projects/197-jev-trader.md) · [English](../../en/projects/197-jev-trader.md)

- 목록: [kraayenjon/awesome-jev](https://github.com/kraayenjon/awesome-jev/blob/22570dcd8662ae039860a1dfad7d7aec4aff8e15/README.md#L197) `README.md:197` @ `22570dcd` (CC0). fivetaku/awesome-jev 포크는 이 커밋으로 클론했다.
- 절: 숫자가 붙은 빌드
- 주소: https://madewithjev.com/builds/jev-trader
- 조회: 2026-09-22
...
300ms Monad 블록 안에서 사고팔기를 정한다. 주문창은 Kuru.

## 확인한 것

- 목록이 같이 적은 숫자: 300 ms decision window. 저자 보고이다 (README.md:209). 재측정하지 않았다.

## Jev의 역할

목록은 이렇게 적는다. 300ms Monad 블록 안에서 사고팔기를 정한다. 주문창은 Kuru. 이 절의 행은 대개 닫힌 라벨이다. 채용 여부, 의도, 매수·매도, 허용·차단. 돈, 메시지, 기록은 일반 코드에 남는다. 그 예는 절의 예이고, 이 행이 그중 하나라는 확인은 아니다. 이 페이지는 그 다음 일을 따라가지 않았다.
