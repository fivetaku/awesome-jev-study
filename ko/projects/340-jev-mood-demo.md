...
[한국어](../../ko/projects/340-jev-mood-demo.md) · [English](../../en/projects/340-jev-mood-demo.md)

- 목록: [kraayenjon/awesome-jev](https://github.com/kraayenjon/awesome-jev/blob/22570dcd8662ae039860a1dfad7d7aec4aff8e15/README.md#L340) `README.md:340` @ `22570dcd` (CC0). fivetaku/awesome-jev 포크는 이 커밋으로 클론했다.
- 절: Demos and games (데모·게임)
- 주소: https://jev-demo.vercel.app
- 조회: 2026-09-22
...
Jev의 자리는 다음 합법 수다. 게임 코드가 상태나 선택지로 만들어 넘긴 것 중에서 고른다. 목록은 이렇게 적는다. Talk nicely or nastily over time; structured state tracks mood. 게임, 합법 수 생성, 입력 주입은 모델 밖에 있다. 이 페이지는 그것들을 따라가지 않았고, 저자가 보고한 속도·비용을 재측정하지 않았다.
