...
[한국어](../../ko/projects/548-awesome-jev-yibie.md) · [English](../../en/projects/548-awesome-jev-yibie.md)

- 목록: [kraayenjon/awesome-jev](https://github.com/kraayenjon/awesome-jev/blob/22570dcd8662ae039860a1dfad7d7aec4aff8e15/README.md#L548) `README.md:548` @ `22570dcd` (CC0). fivetaku/awesome-jev 포크는 이 커밋으로 클론했다.
- 절: Related lists (다른 목록)
- 주소: https://github.com/yibie/awesome-jev
- 조회: 2026-09-22
...
- 실행으로 확인, GitHub API 2026-09-22: `yibie/awesome-jev`, 스타 1212, SPDX none, push 2026-09-22, 아카이브 False, 언어 Python.
- API 설명 한 줄: A curated list of public projects, integrations, and discussions built on Jev — TypeSafe AI's System One model for typed decisions.

## Jev의 역할

이 행은 Jev 통합이 아니다. Jev에 대한 페이지, 글, 목록, FAQ 답이다. 목록은 이렇게 적는다. Jev projects and discussions organized by application domain. 프로젝트가 아닌 앞부분에서 복구할 호출 세팅은 없다. 소셜 글의 문장은 확인된 사실로 취급하지 않는다.
