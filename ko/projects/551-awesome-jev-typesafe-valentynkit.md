...
- 실행으로 확인, GitHub API 2026-09-22: `valentynkit/awesome-jev-typesafe`, 스타 128, SPDX CC0-1.0, push 2026-09-22, 아카이브 False, 언어 JavaScript.
- 목록의 CC0은 이 저장소 코드에 미치지 않는다. 라이선스는 CC0-1.0이다.
- API 설명 한 줄: Typed decisions with TypeSafe's Jev, the first System One model
