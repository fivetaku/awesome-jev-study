...
- 실행으로 확인, GitHub API 2026-09-22: `AnotiaWang/awesome-jev`, 스타 287, SPDX CC0-1.0, push 2026-09-22, 아카이브 False, 언어 -.
- 목록의 CC0은 이 저장소 코드에 미치지 않는다. 라이선스는 CC0-1.0이다.
- API 설명 한 줄: A curated list of awesome Jev / TypeSafe System One applications, libraries, and resources.
