...
이 행은 공식 패턴이다. 목록은 이렇게 적는다. See also: [How to build with System One](https://docs.typesafe.ai/concepts/how-to-build-with-system-one), the [use-case map](https://docs.typesafe.ai/concepts/use-case-map), and [confidence](https://docs.typesafe.ai/confidence). 질문과 코드를 위한 모양이지, 측정된 배포가 아니다. 페이지 앞부분을 실행하지 않았다.
