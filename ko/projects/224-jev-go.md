...
이 저장소는 모델이 아니라 클라이언트다. Jev는 원격 System One 엔드포인트에 있다. 패키지는 그 호출을 한 언어로 적게 해 준다. 목록 문장: `go get github.com/Gaurav-Gosain/jev-go`. Also [Stumble/jev-go](https://github.com/Stumble/jev-go) - dependency-free, works against TypeSafe direct and Vercel AI Gateway, with an interactive CLI and an installable agent skill.
