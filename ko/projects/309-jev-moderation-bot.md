...
Discord 봇. 들어온 메시지를 피싱, 스팸, 사회공학으로 점수를 매기고, 네 단계로 올린다.
...
목록은 이렇게 적는다. Discord 봇. 들어온 메시지를 피싱, 스팸, 사회공학으로 점수를 매기고, 네 단계로 올린다. 이 절의 행은 대개 닫힌 라벨이다. 채용 여부, 의도, 매수·매도, 허용·차단. 돈, 메시지, 기록은 일반 코드에 남는다. 그 예는 절의 예이고, 이 행이 그중 하나라는 확인은 아니다. 이 페이지는 그 다음 일을 따라가지 않았다.
