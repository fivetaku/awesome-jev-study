...
- 목록: [kraayenjon/awesome-jev](https://github.com/kraayenjon/awesome-jev/blob/22570dcd8662ae039860a1dfad7d7aec4aff8e15/README.md#L372) `README.md:372` @ `22570dcd` (CC0). fivetaku/awesome-jev 포크는 이 커밋으로 클론했다.
- 절: Agent tools and MCP servers (에이전트 도구·MCP)
- 주소: https://github.com/legacybridge-tech/pi-typesafe-jev
- 조회: 2026-09-22
...
- 실행으로 확인, GitHub API 2026-09-22: `legacybridge-tech/pi-typesafe-jev`, 스타 2, SPDX NOASSERTION, push 2026-09-17, 아카이브 False, 언어 TypeScript.
- 목록의 CC0은 이 저장소 코드에 미치지 않는다. 라이선스는 NOASSERTION이다.
- API 설명 한 줄: A pi extension that exposes TypeSafe (Jev, System One) judgments as five pi tools, so a model can make narrow semantic judgments while your code and your users keep control of thre

## Jev의 역할

Jev는 에이전트가 부르는 도구로 열려 있거나, 이미 문장을 쓰는 에이전트 앞의 게이트다. 목록은 이렇게 적는다. Exposes System One judgments as five Pi tools; code and users keep control of thresholds, weights, and actions. 에이전트 루프, 권한, 부수 효과는 Jev가 아니다. 이 페이지는 그것들을 따라가지 않았다.
