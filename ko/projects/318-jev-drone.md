...
Jev의 자리는 제어 루프 안의 이산적인 다음 행동이다. 모터, 설정값, 안전 인터록은 모델이 아니다. 목록은 이렇게 적는다. MuJoCo quadrotor: control and safety stay in code; Jev handles slower tactical judgments at 2.5 Hz. 이 페이지는 루프를 따라가지 않았고 주기를 재측정하지 않았다.
