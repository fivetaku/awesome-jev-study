...
- 목록: [kraayenjon/awesome-jev](https://github.com/kraayenjon/awesome-jev/blob/22570dcd8662ae039860a1dfad7d7aec4aff8e15/README.md#L206) `README.md:206` @ `22570dcd` (CC0). fivetaku/awesome-jev 포크는 이 커밋으로 클론했다.
- 절: Featured builds with real numbers (숫자가 붙은 빌드)
- 주소: https://madewithjev.com/builds/jev-drone
- 조회: 2026-09-22
...
- 목록이 같이 적은 숫자: control at 2.5 Hz. 저자 보고이다 (README.md:209). 재측정하지 않았다.

## Jev의 역할

Jev의 자리는 제어 루프 안의 이산적인 다음 행동이다. 모터, 설정값, 안전 인터록은 모델이 아니다. 목록은 이렇게 적는다. Tactical judgment loop flying on hardware 이 페이지는 루프를 따라가지 않았고 주기를 재측정하지 않았다.
