...
브라우저 안의 오리지널 문명 2. Jev가 제국, 도시, 연구, 유닛 행동을 고른다. 실험용이고, 확인된 승리는 아직 없다고 목록이 적는다.
...
Jev의 자리는 다음 합법 수다. 게임 코드가 상태나 선택지로 만들어 넘긴 것 중에서 고른다. 목록은 이렇게 적는다. 브라우저 안의 오리지널 문명 2. Jev가 제국, 도시, 연구, 유닛 행동을 고른다. 실험용이고, 확인된 승리는 아직 없다고 목록이 적는다. 게임, 합법 수 생성, 입력 주입은 모델 밖에 있다. 이 페이지는 그것들을 따라가지 않았고, 저자가 보고한 속도·비용을 재측정하지 않았다.
