...
- 목록: [kraayenjon/awesome-jev](https://github.com/kraayenjon/awesome-jev/blob/22570dcd8662ae039860a1dfad7d7aec4aff8e15/README.md#L434) `README.md:434` @ `22570dcd` (CC0). fivetaku/awesome-jev 포크는 이 커밋으로 클론했다.
- 절: 따라 하는 예제
- 주소: https://docs.typesafe.ai/cookbooks/skill_suggestion
- 조회: 2026-09-22
...
에이전트 스킬 목록의 순위를 매긴 뒤 위쪽 몇 개만 읽는다.
...
이 행은 레시피다. 목록은 이렇게 적는다. 에이전트 스킬 목록의 순위를 매긴 뒤 위쪽 몇 개만 읽는다. 목록이 보여주는 설정은 `state`와 Choice·Noul·Score 질문이고, 임계값은 코드에 남긴다. 레시피는 실행하지 않았다. 커뮤니티 쿡북 코드는 복사하지 않았다.
