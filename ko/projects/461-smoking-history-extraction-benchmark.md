...
[한국어](../../ko/projects/461-smoking-history-extraction-benchmark.md) · [English](../../en/projects/461-smoking-history-extraction-benchmark.md)

- 목록: [kraayenjon/awesome-jev](https://github.com/kraayenjon/awesome-jev/blob/22570dcd8662ae039860a1dfad7d7aec4aff8e15/README.md#L461) `README.md:461` @ `22570dcd` (CC0). fivetaku/awesome-jev 포크는 이 커밋으로 클론했다.
- 절: 벤치마크
- 주소: https://github.com/vclic/smoking-extraction-benchmark
- 조회: 2026-09-22
...
합성 노트 1,000개. 정확도, 비용, 지연에서 Jev와 OpenAI 구조화 출력.

## 확인한 것

- 실행으로 확인, GitHub API 2026-09-22: `vclic/smoking-extraction-benchmark`, 스타 0, SPDX none, push 2026-09-18, 아카이브 False, 언어 Python.
- API 설명 한 줄: Synthetic smoking-history extraction benchmark comparing TypeSafe Jev and OpenAI structured outputs, with reproducible accuracy, cost, and latency results.

## Jev의 역할

이 행은 제품 기능이 아니라 하네스이거나 공개 평가다. 목록은 이렇게 적는다. 합성 노트 1,000개. 정확도, 비용, 지연에서 Jev와 OpenAI 구조화 출력. 목록의 공식 숫자는 벤더 보고다. 이 스터디는 하네스를 다시 돌리지 않았다. 2026-09-22의 evals.typesafe.ai 조회 본문에는, 더 긴 이전 추출이 인용하던 대표 백분율이 없었다. 그래서 그 백분율은 여기 다시 적지 않는다.
