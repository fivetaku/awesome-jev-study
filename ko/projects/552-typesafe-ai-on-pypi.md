...
- 목록: [kraayenjon/awesome-jev](https://github.com/kraayenjon/awesome-jev/blob/22570dcd8662ae039860a1dfad7d7aec4aff8e15/README.md#L552) `README.md:552` @ `22570dcd` (CC0). fivetaku/awesome-jev 포크는 이 커밋으로 클론했다.
- 절: 다른 목록
- 주소: https://pypi.org/project/typesafe-ai/
- 조회: 2026-09-22
...
커뮤니티 리다이렉트 심. 실제 패키지는 `typesafe-sdk`. 슬롭스쿼팅을 막으려고 등록했다.
...
이 행은 Jev 통합이 아니다. Jev에 대한 페이지, 글, 목록, FAQ 답이다. 목록은 이렇게 적는다. 커뮤니티 리다이렉트 심. 실제 패키지는 `typesafe-sdk`. 슬롭스쿼팅을 막으려고 등록했다. 프로젝트가 아닌 앞부분에서 복구할 호출 설정은 없다. 소셜 글의 문장은 확인된 사실로 취급하지 않는다.
