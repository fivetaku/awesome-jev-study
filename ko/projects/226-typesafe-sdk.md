...
[한국어](../../ko/projects/226-typesafe-sdk.md) · [English](../../en/projects/226-typesafe-sdk.md)

- 목록: [kraayenjon/awesome-jev](https://github.com/kraayenjon/awesome-jev/blob/22570dcd8662ae039860a1dfad7d7aec4aff8e15/README.md#L226) `README.md:226` @ `22570dcd` (CC0). fivetaku/awesome-jev 포크는 이 커밋으로 클론했다.
- 절: SDK와 클라이언트
- 주소: https://github.com/joshmn/typesafe-sdk
- 조회: 2026-09-22
...
Ruby 3.1 이상, 재시도, 스레드에 안전한 HTTP 풀. [RubyLLM TypeSafe](https://github.com/kieranklaassen/ruby_llm-typesafe)는 RubyLLM 2의 TypeSafe 제공자다. [typesafe-ai-rails](https://github.com/GenieRobot/typesafe-ai-rails)는 사용량 기록과, 켜면 적용되는 확신 정책을 둔 Rails 연동이다.

## 확인한 것

- 실행으로 확인, GitHub API 2026-09-22: `joshmn/typesafe-sdk`, 스타 6, SPDX MIT, push 2026-09-19, 아카이브 False, 언어 Ruby.
- 목록의 CC0은 이 저장소 코드에 미치지 않는다. 라이선스는 MIT이다.
- API 설명 한 줄: Ruby client for typesafe.ai

## Jev의 역할

이 저장소는 모델이 아니라 클라이언트다. Jev는 원격 System One 엔드포인트에 있다. 패키지는 그 호출을 한 언어로 적게 해 준다. 목록 문장: Ruby 3.1 이상, 재시도, 스레드에 안전한 HTTP 풀. [RubyLLM TypeSafe](https://github.com/kieranklaassen/ruby_llm-typesafe)는 RubyLLM 2의 TypeSafe 제공자다. [typesafe-ai-rails](https://github.com/GenieRobot/typesafe-ai-rails)는 사용량 기록과, 켜면 적용되는 확신 정책을 둔 Rails 연동이다.
