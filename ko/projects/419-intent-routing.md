...
[한국어](../../ko/projects/419-intent-routing.md) · [English](../../en/projects/419-intent-routing.md)

- 목록: [kraayenjon/awesome-jev](https://github.com/kraayenjon/awesome-jev/blob/22570dcd8662ae039860a1dfad7d7aec4aff8e15/README.md#L419) `README.md:419` @ `22570dcd` (CC0). fivetaku/awesome-jev 포크는 이 커밋으로 클론했다.
- 절: Patterns (패턴)
- 주소: https://docs.typesafe.ai/patterns/intent-routing
- 조회: 2026-09-22
...
이 행은 공식 패턴이다. 목록은 이렇게 적는다. Classify, then hand off to logic, a specialist LLM, or a human. 질문과 코드를 위한 모양이지, 측정된 배포가 아니다. 페이지 앞부분을 실행하지 않았다.
