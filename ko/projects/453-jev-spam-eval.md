...
[한국어](../../ko/projects/453-jev-spam-eval.md) · [English](../../en/projects/453-jev-spam-eval.md)

- 목록: [kraayenjon/awesome-jev](https://github.com/kraayenjon/awesome-jev/blob/22570dcd8662ae039860a1dfad7d7aec4aff8e15/README.md#L453) `README.md:453` @ `22570dcd` (CC0). fivetaku/awesome-jev 포크는 이 커밋으로 클론했다.
- 절: 벤치마크
- 주소: https://github.com/bitnovus/jev-spam-eval
- 조회: 2026-09-22
...
학습된 TF-IDF 기준선과 견준 제로샷 스팸 연구. 사후 조정에 대한 단서가 있다.

## 확인한 것

- 실행으로 확인, GitHub API 2026-09-22: `bitnovus/jev-spam-eval`, 스타 0, SPDX MIT, push 2026-09-18, 아카이브 False, 언어 Jupyter Notebook.
- 목록의 CC0은 이 저장소 코드에 미치지 않는다. 라이선스는 MIT이다.
- API 설명 한 줄: Zero-shot spam filtering with TypeSafe Jev Noul questions, compared with TF-IDF baselines

## Jev의 역할

이 행은 제품 기능이 아니라 하네스이거나 공개 평가다. 목록은 이렇게 적는다. 학습된 TF-IDF 기준선과 견준 제로샷 스팸 연구. 사후 조정에 대한 단서가 있다. 목록의 공식 숫자는 벤더 보고다. 이 스터디는 하네스를 다시 돌리지 않았다. 2026-09-22의 evals.typesafe.ai 조회 본문에는, 더 긴 이전 추출이 인용하던 대표 백분율이 없었다. 그래서 그 백분율은 여기 다시 적지 않는다.
