...
[한국어](../../ko/projects/276-jev-shell-history.md) · [English](../../en/projects/276-jev-shell-history.md)

- 목록: [kraayenjon/awesome-jev](https://github.com/kraayenjon/awesome-jev/blob/22570dcd8662ae039860a1dfad7d7aec4aff8e15/README.md#L276) `README.md:276` @ `22570dcd` (CC0). fivetaku/awesome-jev 포크는 이 커밋으로 클론했다.
- 절: 개발 도구·코드 리뷰
- 주소: https://github.com/mrnugget/jev-shell-history
- 조회: 2026-09-22
...
Fish처럼 보이는 zsh 자동 제안. 치는 동안 Jev가 최근 히스토리 순위를 매긴다.

## 확인한 것

- 실행으로 확인, GitHub API 2026-09-22: `mrnugget/jev-shell-history`, 스타 100, SPDX none, push 2026-09-18, 아카이브 False, 언어 TypeScript.
- API 설명 한 줄: Fish-style zsh history autosuggestions ranked by Jev (TypeSafe)

## Jev의 역할

목록은 이렇게 적는다. Fish처럼 보이는 zsh 자동 제안. 치는 동안 Jev가 최근 히스토리 순위를 매긴다. 이 절에 모인 행은 대개 diff, 로그, 커밋, 이미 뽑아 둔 문자열에 대한 판단이고, 파일시스템과 git 호출은 일반 코드가 가진다. 그것은 절의 모양이다. 이 행이 그렇게 생겼다는 확인은 아니다. 이 페이지는 그 코드를 따라가지 않았다.
