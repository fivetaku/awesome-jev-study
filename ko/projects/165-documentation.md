...
[한국어](../../ko/projects/165-documentation.md) · [English](../../en/projects/165-documentation.md)

- 목록: [kraayenjon/awesome-jev](https://github.com/kraayenjon/awesome-jev/blob/22570dcd8662ae039860a1dfad7d7aec4aff8e15/README.md#L165) `README.md:165` @ `22570dcd` (CC0). fivetaku/awesome-jev 포크는 이 커밋으로 클론했다.
- 절: 공식 자료
- 주소: https://docs.typesafe.ai/introduction
- 조회: 2026-09-22
...
소개, 기본 질문, 패턴, API, SDK. [시작 예제](https://docs.typesafe.ai/introduction/quickstart)부터 보라고 목록이 적는다.
...
이 행은 커뮤니티 통합이 아니라 TypeSafe 페이지이거나 목록 자신의 표다. 다루는 것: 소개, 기본 질문, 패턴, API, SDK. [시작 예제](https://docs.typesafe.ai/introduction/quickstart)부터 보라고 목록이 적는다.
