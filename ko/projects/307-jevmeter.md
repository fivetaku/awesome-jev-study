...
[한국어](../../ko/projects/307-jevmeter.md) · [English](../../en/projects/307-jevmeter.md)

- 목록: [kraayenjon/awesome-jev](https://github.com/kraayenjon/awesome-jev/blob/22570dcd8662ae039860a1dfad7d7aec4aff8e15/README.md#L307) `README.md:307` @ `22570dcd` (CC0). fivetaku/awesome-jev 포크는 이 커밋으로 클론했다.
- 절: 업무용 앱
- 주소: https://github.com/ChetasLua/jevmeter
- 조회: 2026-09-22
...
아무 영상에나 얹는 라이브 Jev 미터. 문장마다 점수를 매겨 16:9 편집으로 그린다.

## 확인한 것

- 실행으로 확인, GitHub API 2026-09-22: `ChetasLua/jevmeter`, 스타 81, SPDX MIT, push 2026-09-17, 아카이브 False, 언어 Python.
- 목록의 CC0은 이 저장소 코드에 미치지 않는다. 라이선스는 MIT이다.
- API 설명 한 줄: Put a live Jev (TypeSafe) meter on any video: every sentence scored, rendered as a 16:9 edit

## Jev의 역할

목록은 이렇게 적는다. 아무 영상에나 얹는 라이브 Jev 미터. 문장마다 점수를 매겨 16:9 편집으로 그린다. 이 절의 행은 대개 닫힌 라벨이다. 채용 여부, 의도, 매수·매도, 허용·차단. 돈, 메시지, 기록은 일반 코드에 남는다. 그 예는 절의 예이고, 이 행이 그중 하나라는 확인은 아니다. 이 페이지는 그 다음 일을 따라가지 않았다.
