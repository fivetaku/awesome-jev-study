...
Jev는 저자가 이미 모아 둔 더미의 모든 항목에 같은 닫힌 질문을 한다. 목록은 이렇게 적는다. 말뭉치를 주제로 분류해 사이트로 공개했다. 그 문장 옆의 숫자는 저자 보고다. README.md:209는 목록이 재지 않았다고 적는다. 이 스터디도 재지 않았다.
